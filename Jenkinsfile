    ...
    stages {
        stage('Подготовка') {
            steps {
                ...
                git 'https://github.com/Rokaramov/pi225team10.git/'
                sh "mvn clean"
            ...
            steps {
                ...
                script {
                    if ("${params.Deploy}"=="true") {
                        deploy adapters: [tomcat9(credentialsId: 'd7a6a324-46af-43da-a015-5fc459e50179', path: '', url: 'http://xn--e1afhkfagivn.xn--p1ai:8081/Laba4Web')], contextPath: "${params.Name}", war: '**/*.war'
                    }
                }
            }
        }
